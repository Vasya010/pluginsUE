...
FRotator AGAS_MainCharacterCpp::GetViewRotation() const
{
	FRotator CustomRot = FRotator(0, 0, 0);
	const bool bUseCustom = GetCustomViewRotation_Implementation(CustomRot);
	if (bUseCustom)
	{
		return CustomRot;
	}
...
FRotator AGAS_MainCharacterCpp::GetBaseAimRotation() const
{
	FRotator CustomRot = FRotator(0, 0, 0);
	const bool bUseCustom = GetCustomBaseAimRotation_Implementation(CustomRot);
	if (bUseCustom)
	{
		return CustomRot;
	}
...
bool AGAS_MainCharacterCpp::GetCustomViewRotation_Implementation(FRotator& ReturnRotation) const
{
	ReturnRotation = GetActorRotation();
	return false;
}

bool AGAS_MainCharacterCpp::GetCustomBaseAimRotation_Implementation(FRotator& ReturnRotation) const
{
	ReturnRotation = GetActorRotation();
	return false;
}
