...
void UCpp_FallDamageAndSliding::PrepareToSlidingC_Implementation(bool CanStart)
{
	...
	SavedCharMoveValuesC.bUseSeparateBrakingFriction = CharC->GetCharacterMovement()->bUseSeparateBrakingFriction;

	CharC->UnCrouch(); //UnCrouch Character
	CharC->GetCharacterMovement()->bUseSeparateBrakingFriction = true; //Change ChararacterMovement param
	return;
}
