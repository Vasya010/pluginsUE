...
public:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Traversal Core| Mantle", meta = (DisplayName = "Check Mantle", Keywords = "Traversal Parkour system", AdvancedDisplay = "TraceChannel,CapHeightScale,CapRadiusScale,CapSizeByDef,VelocityOffsetScale,LedgeFindingRadius,UseAxisAsForward,DebugTime"))
	bool CheckMantle(float& MantleHeight, FCALS_ComponentAndTransform& MantleLedgeWS, FCALS_ComponentAndTransform& VaultLedgeWS, FCALS_ComponentAndTransform& MantleCapsuleWS, CALS_MantleType& MantleType,
		FTraversalTraceSettings TraceSettings, ETraceTypeQuery TraceChannel, float CapHeightScale = 0.85, float CapRadiusScale = 0.9, bool CapSizeByDef = false, float VelocityOffsetScale = 1.0, float LedgeFindingRadius = 2.0, bool UseAxisAsForward = false, float DebugTime = 0.5);
