...
protected:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintPure, Category = "ALS Character", meta = (DisplayName = "Can Sprint Fast", Keywords = "ALS Character"))
	bool CalcCanSprint();
	virtual bool CalcCanSprint_Implementation();

	UFUNCTION(BlueprintCallable, Category = "ALS Character", meta = (DisplayName = "Update Dynamic Movement Settings Fast", Keywords = "ALS Character"))
	virtual void UpdateMovementSettings(CALS_Gait AllowedGait, FCALSMovementSettings CurrentMovement);

	UFUNCTION(BlueprintNativeEvent, BlueprintPure, Category = "ALS Character", meta = (DisplayName = "Get Allowed Gait Fast", Keywords = "ALS Character"))
	CALS_Gait GetAllowedGaitFast();
	virtual CALS_Gait GetAllowedGaitFast_Implementation();

	UFUNCTION(BlueprintNativeEvent, BlueprintPure, Category = "ALS Character", meta = (DisplayName = "Get Actual Gait Fast", Keywords = "ALS Character"))
