...
protected:
	...
	//This Value Should Return Same Value As 'IsMovingC'
	UFUNCTION(BlueprintNativeEvent, BlueprintPure, Category = "MM Movement Analyze", meta = (DisplayName = "Get Is Moving Value", Keywords = "Motion Matching", BlueprintThreadSafe))
	bool GetIsMovingValue();
	bool GetIsMovingValue_Implementation();
