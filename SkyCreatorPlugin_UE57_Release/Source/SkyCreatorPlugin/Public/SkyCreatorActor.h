...
UENUM(BlueprintType)
enum ESkyCreatorValueSource
{
	ValueSource_Actor UMETA(DisplayName = "From Actor"),
	ValueSource_WeatherSettings UMETA(DisplayName = "From Weather Settings")
};
...
//	UStaticMeshComponent* SkySphere;
	...
	*/
	...
	/** Desc. */
//	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Sun & Moon Position|Light Transition", DisplayName = "Sun Light Intensity Modulated", meta = (EditCondition = "bShowDebugVariables", EditConditionHides))
//	float SunLightIntensityModulated = 0.0f;

	/** Desc. */
//	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Sun & Moon Position|Light Transition", DisplayName = "Moon Light Intensity Modulated", meta = (EditCondition = "bShowDebugVariables", EditConditionHides))
//	float MoonLightIntensityModulated = 0.0f;
...
//	bool bSunConstantIntensity = true;
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Sun Light", DisplayName = "Sun Intensity Source")
	TEnumAsByte<ESkyCreatorValueSource> SunIntensitySource = ESkyCreatorValueSource::ValueSource_Actor;

	/** Sun Constant Intensity. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Interp, Category = "Sun Light", DisplayName = "Sun Intensity", meta = (EditCondition = "SunIntensitySource == ESkyCreatorValueSource::ValueSource_Actor", ClampMin = "0.0", UIMin = "0.0"))
	float SunIntensity = 10.0f;

	/** Desc. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Sun Light", DisplayName = "Sun Elevation Intensity Scale", meta = (InlineEditConditionToggle))
	bool bUseSunElevationIntensityScale = false;

	/** Desc. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Sun Light", DisplayName = "Sun Elevation Intensity Scale Curve", meta = (EditCondition = "bUseSunElevationIntensityScale"))
	UCurveFloat* SunElevationIntensityScaleCurve;

	/** Sun Current Intensity. */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Interp, Category = "Sun Light", DisplayName = "Sun Calculated Intensity", meta = (EditCondition = "bShowDebugVariables", EditConditionHides))
	float SunCalculatedIntensity = 0.0f;
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Sun Light|Atmosphere And Cloud", DisplayName = "Sun Atmosphere Disk Color Scale Source")
	TEnumAsByte<ESkyCreatorValueSource> SunAtmosphereDiskColorScaleSource = ESkyCreatorValueSource::ValueSource_Actor;
...
//	bool bSunConstantAtmosphereDiskColorScale = false;
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Interp, Category = "Sun Light|Atmosphere And Cloud", DisplayName = "Atmosphere Disk Color Scale", meta = (EditCondition = "SunAtmosphereDiskColorScaleSource == ESkyCreatorValueSource::ValueSource_Actor"))
...
//	bool bMoonConstantIntensity = true;
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Moon Light", DisplayName = "Moon Intensity Source")
	TEnumAsByte<ESkyCreatorValueSource> MoonIntensitySource = ESkyCreatorValueSource::ValueSource_Actor;

	/** Moon Constant Intensity. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Interp, Category = "Moon Light", DisplayName = "Moon Intensity", meta = (EditCondition = "MoonIntensitySource == ESkyCreatorValueSource::ValueSource_Actor", ClampMin = "0.0", UIMin = "0.0"))
	float MoonIntensity = 0.04f;

	/** Desc. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Moon Light", DisplayName = "Moon Elevation Intensity Scale", meta = (InlineEditConditionToggle))
	bool bUseMoonElevationIntensityScale = false;

	/** Desc. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Moon Light", DisplayName = "Moon Elevation Intensity Scale Curve", meta = (EditCondition = "bUseMoonElevationIntensityScale"))
	UCurveFloat* MoonElevationIntensityScaleCurve;

	/** Sun Current Intensity. */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Interp, Category = "Moon Light", DisplayName = "Moon Calculated Intensity", meta = (EditCondition = "bShowDebugVariables", EditConditionHides))
	float MoonCalculatedIntensity = 0.0f;
	...
	*/
	...
	float MoonPhaseLightIntensityMinScale = 0.1f;
	...
	/** Whether to use constant Atmosphere Disk Color Scale for Sun. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Moon Light|Atmosphere And Cloud", DisplayName = "Moon Atmosphere Disk Color Scale Source")
	TEnumAsByte<ESkyCreatorValueSource> MoonAtmosphereDiskColorScaleSource = ESkyCreatorValueSource::ValueSource_Actor;
...
//	bool bMoonConstantAtmosphereDiskColorScale = false;
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Interp, Category = "Moon Light|Atmosphere And Cloud", DisplayName = "Atmosphere Disk Color Scale", meta = (EditCondition = "SunAtmosphereDiskColorScaleSource == ESkyCreatorValueSource::ValueSource_Actor"))
...
//	float CloudWindSkewAmount = 0.25f;
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Post Process", meta = (ClampMin = "-10.0", UIMax = "20.0", EditCondition = "bUseExposureSettings && !bExtendDefaultLuminanceRange", EditConditionHides, DisplayName = "Min Brightness"))
	...
	* The Min/Max are expressed in pixel luminance (cd/m2).
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Post Process", meta = (ClampMin = "-10.0", UIMax = "20.0", EditCondition = "bUseExposureSettings && !bExtendDefaultLuminanceRange", EditConditionHides, DisplayName = "Max Brightness"))
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Post Process", AdvancedDisplay, meta = (UIMin = "-16", UIMax = "0.0", EditCondition = "bUseExposureSettings && !bExtendDefaultLuminanceRange", EditConditionHides, DisplayName = "Histogram Log Min"))
	float ExposureHistogramLogMin = -16.0f;

	/** Histogram Max value. Expressed in Log2(Luminance). */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Post Process", AdvancedDisplay, meta = (UIMin = "0.0", UIMax = "16.0", EditCondition = "bUseExposureSettings && !bExtendDefaultLuminanceRange", EditConditionHides, DisplayName = "Histogram Log Max"))
	...
	UFUNCTION(BlueprintPure, Category = "Sky Creator|Weather")
	FSkyCreatorMaterialFXSettings GetMaterialFXSettings() const;
...
//	void SetMoonPhase(float InMoonPhase);
	...
	UFUNCTION(BlueprintPure, Category = "Sky Creator")
...
private:
	...
	void UpdateSettings();
	void UseExposureSettings();

	template<typename T>
	T GetValueSource(const TEnumAsByte<ESkyCreatorValueSource> ValueSource, const T FromActor, const T FromWeatherSettings)
	{
		T LocalResult;
		switch (ValueSource)
		{
		case 0:
			{
				LocalResult = FromActor;
				break;
			}
		case 1:
			{
				LocalResult = FromWeatherSettings;
				break;
			}
		default:
			{
