...
struct FSkyCreatorSunLightSettings
{
	...
	/** Maximum illumination from the light in lux. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category = "Sun Light", DisplayName = "Intensity Scale", meta = (ClampMin = "0.0", UIMin = "0.0"))
...
struct FSkyCreatorMoonLightSettings
{
	...
	/** Maximum illumination from the light in lux. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category = "Moon Light", DisplayName = "Intensity Scale", meta = (ClampMin = "0.0", UIMin = "0.0"))
	float IntensityScale = 1.0f;
